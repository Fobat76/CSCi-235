...
*/
    Ingredient(const std::string &NewName_, const std::string  &NewDescription_, const int  &NewQuantity_, 
...
*/
    Pantry(const std::string &inputfilename); // Parameterize constructor 
...
*/
    int getPosOf(const std::string&IngredientName);

/**
    @param: A const string reference to a ingredient name
    @return: True if the ingredient information is already in the Pantry
*/
    bool contains(const std::string&IngredientName);
...
*/
    bool addIngredient(const std::string& ingredient_name, const std::string& ingredient_description, const int& ingredient_quantity
