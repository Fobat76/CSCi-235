...
*/
Ghoul(const std::string &new_name, Category new_type = UNDEAD, int new_hitpoint = 1,int new_level = 1, bool new_tame = false, int new_decay = 0, Faction new_faction = NONE, bool new_transform = false);
...
*/
bool setDecay(const int &new_decay);
...
*/
void setTransformation(const bool &new_transformation);
